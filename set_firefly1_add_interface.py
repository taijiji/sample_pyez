...
print "#"*30
interface_info = dev1.rpc.get_interface_information(
                    interface_name='ge-0/0/2',
                    terse=True
                    )
print Fore.YELLOW + etree.tostring(interface_info)
print "#"*30
...
with open(template_filename, 'r') as conf:
    ...
    print Environment().from_string(template_txt).render(param_interface)
print "#"*30
